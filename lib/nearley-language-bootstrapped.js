...
var grammar = {
    ...
    {"name": "prod", "symbols": [{"literal":"@"}, "_", "jsForNearley"], "postprocess": function(d) { return {body: d[2]}; }},
    {"name": "prod", "symbols": [{"literal":"@"}, "_", "jsForUpdateContext"], "postprocess": function(d) { return {body: d[2]}; }},
    ...
    {"name": "completeexpression", "symbols": ["expr", "_", "jsForNearley"], "postprocess": function(d) { return {tokens: d[0], postprocess: d[2]}; }},
    {"name": "completeexpression", "symbols": ["expr", "_", "jsForUpdateContext"], "postprocess": function(d) { return {tokens: d[0], updateContext: d[2]}; }},
    ...
    {"name": "expr_member", "symbols": [{"literal":"^"}, "word"], "postprocess": function(d) {return {token: `{produce: (generator, context) => generator.get(context, "${d[1]}"), name: "${d[1]}"}`}}},
    ...
    {"name": "jsForNearley", "symbols": [(lexer.has("jsForNearley") ? {type: "jsForNearley"} : jsForNearley)], "postprocess": getValue},
    {"name": "jsForUpdateContext", "symbols": [(lexer.has("jsForUpdateContext") ? {type: "jsForUpdateContext"} : jsForUpdateContext)], "postprocess": getValue},
